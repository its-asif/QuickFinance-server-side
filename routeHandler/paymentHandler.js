...
router.post('/', async (req, res) => {
    ...
    const data = {
        ...
        success_url: `https://quick-finance-server-side-zeta.vercel.app/api/payments/payment/success/${transId}`,
        fail_url: `https://quick-finance-server-side-zeta.vercel.app/api/payments/payment/fail/${transId}`,
        cancel_url: 'https://quick-finance-server-side-zeta.vercel.app/cancel',
        ipn_url: 'https://quick-finance-server-side-zeta.vercel.app/ipn',
